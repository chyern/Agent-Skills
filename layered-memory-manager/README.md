...
- **Archive System**: Cold L2 entries are moved to `memory/archive/` after 30 days of inactivity, preventing storage bloat.
- **Self-Healing**: Automated `hygiene.json` tracking and recovery mechanisms.
